...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		...
		case 'registrar':
            ...
            $gam->__SET('nvchlinkdownpc', $_REQUEST['nvchlinkdownpc']);
            $gam->__SET('nvchlinkdownios', $_REQUEST['nvchlinkdownios']);
            $gam->__SET('nvchfecha', $_REQUEST['nvchfecha']);
                ...
                <table class="pure-table pure-table-horizontal">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr style="text-transform: uppercase;">
                            ...
                            <td>
                                <iframe name=miframeflotante src="<?php echo $r->__GET('nvchlinkspot');?>" width='100' height=auto frameborder="0" scrolling=yes marginwidth=2 marginheight=4 align=left>Video Oitch</iframe>
                            </td>
                            <td>
