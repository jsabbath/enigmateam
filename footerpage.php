      ...
      <div class="container">
        <div class="row">
          <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Contactanos</h2>
            <p>Cualquier duda o consulta, no dudes en escribirnos, atenderemos gustosamente</p>
          </div>
        </div>
                ...
                <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input type="text" name="name" class="form-control" placeholder="Nombre de pila" required="required">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
